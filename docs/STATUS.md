...
**Last updated:** 2026-07-09 (Phase 2 COMPLETE: address book, automatic best-sellers, product reviews all landed)
...
**Code side: Phase 2 is COMPLETE (R18 order finished 2026-07-09). Next code work is Phase 3+ (coupons, wishlist, multi-admin, analytics, i18n, reservation, dark theme) — do not start without the owner picking an item.** The launch blocker remains owner provisioning (below).
