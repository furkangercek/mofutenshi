...
**Last updated:** 2026-07-06 (Phase 2: automatic invoicing landed)
...
**Code side: continue Phase 2 — next item is the owner's call.** Remaining Phase 2 items: address book / saved addresses, product reviews, automatic best-sellers.
